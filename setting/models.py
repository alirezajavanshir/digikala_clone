...
class SiteSetting(models.Model):
    ...
    logo = models.ImageField(
        blank=True, upload_to=upload_image_path, verbose_name="لوگو"
    )
...
class FAQCategory(models.Model):
    ...
    image = models.ImageField(
        upload_to=upload_image_cat_faq_path, verbose_name="تصویر", blank=True, null=True
    )
...
class FAQ(models.Model):
    ...
    category = models.ForeignKey(
        FAQCategory, on_delete=models.CASCADE, verbose_name="دسته"
    )
