...
class Size(models.Model):
    ...
    code = models.CharField(
        max_length=10, blank=True, null=True, verbose_name="کد سایز"
    )
...
class Variants(models.Model):
    ...
    title = models.CharField(
        max_length=100, blank=True, null=True, verbose_name="ویژگی"
    )
    ...
    color = models.ForeignKey(
        Color, on_delete=models.SET_NULL, blank=True, null=True, verbose_name="رنگ"
    )
    size = models.ForeignKey(
        Size, on_delete=models.SET_NULL, blank=True, null=True, verbose_name="سایز"
    )
    image_id = models.IntegerField(
        blank=True, null=True, default=0, verbose_name="آی‌دی تصویر"
    )
    quantity = models.IntegerField(default=1, verbose_name="تعداد")
    price = models.IntegerField(default=0, verbose_name="قیمت")
    status = models.CharField(
        max_length=50, choices=STATUS, default="True", verbose_name="وضعیت"
    )
