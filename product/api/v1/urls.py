...
from .views import (
    ...
    BrandDetailAPIViewSet,
    ProductFavouriteUpdateAPIView,
)

urlpatterns = [
    path("product/list", ProductListAPIViewSet.as_view(), name="products_api"),
    path(
        "product/<int:pk>/", ProductDetailAPIView.as_view(), name="products_detail_api"
    ),
    ...
    path(
        "product/favourite/update",
        ProductFavouriteUpdateAPIView.as_view(),
        name="product_favourite_update_api",
    ),
]
