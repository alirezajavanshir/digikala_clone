...
class ProductFilter(django_filters.FilterSet):
    ...
    brand = CustomModelMultipleChoiceFilter(
    ...
    amount = filters.NumberFilter(
        field_name="amount", lookup_expr="gte", label="کالاهای موجود"
    )
    order_by = filters.CharFilter(
        field_name="order_by", method="filter_order_by", label="مرتب شده براساس"
    )
