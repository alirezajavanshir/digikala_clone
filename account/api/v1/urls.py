...
from .views import (
    ...
    ProfileCommentListAPIView,
    ProfileCommentDetailAPIView,
    ProfileHistoryListAPIView,
    ProfileProductFavouriteUpdateAPIView,
    UserRegisterAPIViewSet,
    UpdatePassword,
)
...
urlpatterns = [
    ...
    path(
        "profile/address/<int:pk>/",
        UserAddressUpdateAPIView.as_view(),
        name="address_api",
    ),
    path("profile/order/list/", OrderListAPIView.as_view(), name="order_list_api"),
    path(
        "profile/order/<int:pk>/", OrderDetailAPIView.as_view(), name="order_detail_api"
    ),
    path(
        "profile/info/<int:pk>/",
        UserProfileAPIViewSet.as_view(),
        name="profile_info_api",
    ),
    path(
        "profile/comment/list/",
        ProfileCommentListAPIView.as_view(),
        name="profile_comment_list_api",
    ),
    path(
        "profile/comment/<int:pk>/",
        ProfileCommentDetailAPIView.as_view(),
        name="profile_comment_delete_api",
    ),
    path(
        "profile/history/list/",
        ProfileHistoryListAPIView.as_view(),
        name="profile_history_list_api",
    ),
    path(
        "profile/favourite/list/",
        ProfileProductFavouriteUpdateAPIView.as_view(),
        name="profile_favourite_list_api",
    ),
