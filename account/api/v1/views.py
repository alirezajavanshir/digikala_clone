...
from .serializers import (
    ...
    ProfileCommentDetailSerializer,
    ProfileHistoryListSerializer,
    profileFavouriteListSerializer,
...
class UpdatePassword(generics.UpdateAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            self.object.save()
            return Response(
                data="پسورد با موفقیت تغییر یافت. لطفا دوباره لاگین کنید",
...
class UserAddressUpdateAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        other_add = UserAddress.objects.filter(
...
class OrderListAPIView(generics.ListAPIView):
    ...
    def get_queryset(self):
        return Order.objects.filter(user__username=self.request.user.username).order_by(
            "-id"
        )
